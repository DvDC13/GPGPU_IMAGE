...
__global__ void calculateBitVector(const Pixel* imageData, uint8_t*
        bitVectorData, size_t batch_size, int width, int height, size_t imagePitch, size_t bitVecPitch);
